...
This plot presents the percentage of IDRS and EDRS participants from `r paste0(ifelse(params$city %in% c("ACT","NT"),'the ',''),params$city)` who reported at least weekly use in the last 6 months related to `r params$udrug`. In `r params$yr00[2]` `r paste0(tail(params$IDRSw$est, n=1),"%")` of IDRS respondents reported weekly or more frequent use, compared to `r paste0(tail(params$EDRSw$est, n=1),"%")` in the EDRS.
